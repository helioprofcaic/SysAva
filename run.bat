...
"%VENV_PATH%\Scripts\pip.exe" install --upgrade pip -r requirements.txt psutil requests flask google-generativeai filelock
...
if "!NETWORK_STATUS!"=="Offline" (
    ...
    if %errorlevel% == 1 (
        ...
        netsh wlan set hostednetwork mode=allow ssid=SysAva-Offline key=12345678
        netsh wlan start hostednetwork
        echo.
        echo Hotspot 'SysAva-Offline' iniciado.
        echo Senha: 12345678
        echo.
